            ...
            <div class="container">
                <div class="footer__wrap">
                    <a href="<?=get_home_url()?>" class="footer__logo">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/images/static/footer-logo.png"
                            alt="logo">
                    </a>
                    <a href="<?=get_home_url()?>" class="footer__logo footer__logo--mobile">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/images/static/footer-logo-mobile.png"
                            alt="logo">
                    </a>
...
?>
                    ...
                    <form class="search search--one" role="search" method="get" id="searchform"
                        action="<?php echo home_url('/') ?>">
                        <input type="text" class="search__input" placeholder="Поиск..."
                            value="<?php echo get_search_query() ?>" name="f" id="f">
                    ...
                    <div class="footer__nav-wrapper footer__nav-wrapper--three">
                        <ul class="footer__nav footer__nav-wrapper footer__nav-wrapper--mobile">
                            ...
                            <li class="footer__item footer__item--mail">
                                <a href="mailto:<? the_field('pochtovyj_adress', 2); ?>" class="footer__link">
                                    <? the_field('pochtovyj_adress', 2); ?>
                                </a>
                            </li>
                            <li class="footer__item footer__item--phone">
                                <a href="tel:<? the_field('nomer_telefona', 2) ?>" class="footer__link">
                                    <? the_field('nomer_telefona', 2) ?>
                                </a>
                            </li>
                            ...
                            <li class="footer__item footer__item--download">
                                <a href="<? the_field('rekvizity_fajl', 2) ?>" download
                                    class="footer__item-link--download">Скачать реквизиты</a>
                            </li>
                            <li class="footer__item footer__item--download">
                                <a href="/privacy-policy/" class="footer__item-link--download">Политика
                    ...
                    <div class="footer__info">
                        <div style="text-align: right">
                            <form class="search search--two" role="search" method="get" id="searchform-mobile-footer"
                                action="<?php echo home_url('/') ?>">
                                <input type="text" class="search__input" placeholder="Поиск..."
                                    value="<?php echo get_search_query() ?>" name="s" id="footer-n">
    ...
    <div class="development">
        <div class="container">
            <div class="development__inner">
                ...
                <a href="https://t-code.ru/" target="_blank" class="development__name">Разработка и продвижение сайта —
                    true.code</a>
            </div>
        </div>
    </div>
